...
public class Jigglypuff extends Pokemon implements java.io.Serializable{
	
	private String Pokename = "Jigglypuff";//ÅÖ¶¡
	private int attack = 5;
	private int HP = 115;
	private int maxHP = 115;
